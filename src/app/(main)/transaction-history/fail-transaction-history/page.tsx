...
const FailTransactionHistory = () => {
  ...
  const handleDataTransHistory = data.map((item) => ({
    ...item,
    codeVoucher: (
      <span className="text-sm font-normal tracking-wide text-[#525C67]">
        {item.codeVoucher}
      </span>
    ),
    codeInvoice: (
    ...
    timeSuccess: (
      <div>
        <div className="text-sm font-normal tracking-wide text-[#525C67]">
    ...
    reason: (
      <span className="text-sm font-normal text-[#525C67] tracking-wide">{item.reason}</span>
    ),
  }));
  return (
    <div>
