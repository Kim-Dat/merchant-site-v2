...
import AccountChangeAuthForm from "./account-change-auth-form/AccountChangeAuthForm";
import { OnCancelModalContext } from "../AccountModals";

const AccountChangeAuthModal = () => {
...
export default AccountChangeAuthModal;
